...
struct TypeHelper<ValueType, bool> {
    static bool Is(const ValueType& v) { return v.IsBool_(); }
    static bool Get(const ValueType& v) { return v.GetBool_(); }
    static ValueType& Set(ValueType& v, bool data) { return v.SetBool_(data); }
    static ValueType& Set(ValueType& v, bool data, typename ValueType::AllocatorType&) { return v.SetBool_(data); }
};
...
public:
    ...
    */
    ...
    bool IsBool_()   const { return (data_.f.flags & kBool_Flag) != 0; }
    ...
    bool GetBool_() const { RAPIDJSON_ASSERT(IsBool_()); return data_.f.flags == kTrueFlag; }
    //!< Set boolean value
    /*! \post IsBool_() == true */
    ...
    */
    ...
    bool Accept(Handler& handler) const {
        ...
        case kFalseType:    return handler.Bool_(false);
        case kTrueType:     return handler.Bool_(true);
...
public:
    ...
    bool Bool_(bool b) { new (stack_.template Push<ValueType>()) ValueType(b); return true; }
